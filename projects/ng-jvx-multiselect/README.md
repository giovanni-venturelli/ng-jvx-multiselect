...
| `paginationProp`         | `{ page: string, pageSize: string }`              | `{page: 'page', pageSize: 'size'}`                                                         | The mapping for pagination request parameters.                                                                                                                                                        |
| `paginationResponse`     | `{ currentPage: string, totalPages: string, totalRows: string }` | `{ currentPage: 'pageNo', totalPages: 'pageCount', totalRows: 'totalRecordCount' }` | The mapping for pagination response properties.                                                                                                                                                       |
| `paginationResponseProp` | `input<string>`                                          | `'pagingInfo'`                                                                             | The property in the response that contains the pagination information.                                                                                                                                |
